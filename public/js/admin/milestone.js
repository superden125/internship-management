...
function editMilestone(id) {
    ...
    child[0].innerHTML = `<select name="schoolYear" id="schoolYear" class="custom-select"> <option value="${semester1}">${semester1}</option> <option value="${semester2}">${semester2}</option> </select>`
    child[1].innerHTML = `<select name="semester" id="semester" class="custom-select"> <option value="1">1</option> <option value="2">2</option> <option value="3">3</option> </select>`
